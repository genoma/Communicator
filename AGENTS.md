...
- Host machine: macOS 26.6.2 (Darwin 25.6.0, Apple Silicon M5), Homebrew at `/opt/homebrew` (brew 6.0.22, `make` 3.81), login shell zsh 5.9.2, git is Homebrew git 2.55.0 (`/usr/bin/git` reports `git version 2.54.0 (Apple Git-157)`). Node/npm/npx come from Homebrew (`/opt/homebrew/bin`): node v26.8.2, npm 11.19.1.
...
- Baseline: full test suite (1617 tests on tag `3.48.2`; 1656 as of `3.48.6`; 1822 on `4.0.0`; 1844 as of `4.1.0`; 1849 as of `4.1.1`; 1968 as of `4.2.1`; 1990 as of `4.3.0`; 1994 as of `4.3.1`; 1996 as of `4.4.0`; 2000 as of `5.0.0`; 2003 as of `5.0.1`; 2238 as of `5.0.2`, identical on Node 22/24/26), and lint + `npx knip` pass; keep all three green.
