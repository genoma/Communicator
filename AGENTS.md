...
- Baseline: full test suite (1617 tests on tag `3.48.2`; 1656 as of `3.48.6`; 1822 on `4.0.0`; 1844 as of `4.1.0`; 1849 as of `4.1.1`; 1968 as of `4.2.1`; 1990 as of `4.3.0`; 1994 as of `4.3.1`; 1996 as of `4.4.0`; 2000 as of `5.0.0`, identical on Node 22/24/26), and lint + `npx knip` pass; keep all three green.
