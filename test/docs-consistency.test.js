...
test('key defaults and enum values are mentioned in the docs', async () => {
  ...
  const tokens = [
    ...
    ['default top-p', String(constants.DEFAULT_TOP_P)],
    ...
    ['max image dimension', String(constants.MAX_IMAGE_DIMENSION)],
    ['image generation timeout', `${constants.IMAGE_GEN_TIMEOUT_MS / 60000} minutes`],
    ['image seed bound', String(constants.MAX_SEED)],
    ...
    ['image formats', backtickList([...constants.IMAGE_FORMATS])],
    ['image resolutions', backtickList([...constants.IMAGE_RESOLUTIONS])],
    ['image qualities', backtickList([...constants.IMAGE_QUALITIES])],
