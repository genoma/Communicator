...
- **RPG mode** — `--rpg <dir>` assembles `char.md`, `user.md`, and `prompt.md` into one fixed roleplay system prompt; missing files are created as fill-in templates. See [docs/chat.md](docs/chat.md)
