...
- **Limits** — images over 20 MB and pdf/office files over 25 MB are rejected based on the base64-encoded size; text files over 25 MB are rejected too. Inline text over 256 KB is still accepted but warns about context usage.
