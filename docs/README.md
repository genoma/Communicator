...
| [images.md](images.md) | Image generation on Venice and OpenRouter: unified model picker, image sessions, `--image` flags, `/image`, `/aspect`/`/format`, `-m` parity, model listing, sizing defaults, storage |
