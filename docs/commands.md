...
|       | `--budget`            | `<usd>`  | Per-session budget cap in USD. In interactive sessions it warns at 80% used and refuses turns at 100%; one-shot runs never pre-check it. Bare use saves the default |
